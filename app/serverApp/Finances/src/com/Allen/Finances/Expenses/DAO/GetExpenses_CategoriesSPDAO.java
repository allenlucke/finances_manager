...
public class GetExpenses_CategoriesSPDAO {
	...
	public GetExpenses_CategoriesSPDAO() {}
	
	public List<ExpensesCategoriesModel> callGetExpensesCategories(GetExpensesHttpRequestModel request) throws ServletException {
		
		CatalinaSimpleLog.log("INFO", CLASS_NAME, "In GetExpenses_CategoriesSPDAO");
			
			final String methodName = "callGetExpensesCategories()";
			
			final String query = "{call GetExpenses_Categories(?,?,?,?,?,?,?,?,?,?,?,?)}";
			...
			try{
				...
				List<ExpensesCategoriesModel> expensesCategoriesResultList = new ArrayList<ExpensesCategoriesModel>();
				...
				while(rs.next()) {
				    ...
				    obj.setPaid_on(rs.getString("paid_on"));
				    ...
				    expensesCategoriesResultList.add(obj);

				}
				CatalinaSimpleLog.log("INFO", CLASS_NAME, methodName, "Returning result set of "+String.valueOf(expensesCategoriesResultList.size()));
				return expensesCategoriesResultList;
			}
