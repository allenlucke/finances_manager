...
public class ExpenseCategoryDao {
    ...
    protected List<ExpenseCategoryModel> getAllExpCats(final int usersId) {
    ...
    protected List<ExpenseCategoryModel> adminGetAllExpCats() {
    ...
    //User may only access expense categories assigned to the user
    protected List<ExpenseCategoryModel> getExpCatById(final int catId, final int usersId){
    ...
    protected List<ExpenseCategoryModel> adminGetExpCatById(final int id){
    ...
    //User may only access expense categories assigned to the user
    protected List<ExpenseCategoryModel> getExpenseCatsNotAssignedToBudget(final int budgetId, final int usersId) {
    ...
    protected List<ReturnIdModel> addExpCatReturnId(final ExpenseCategoryModel expCat) {
    ...
    protected boolean deleteExpCatById(final int catId, final int usersId) {
